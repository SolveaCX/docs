...
<Tip>
  Any model ID in the [Model Directory](https://flatkey.ai/models) works with the OpenAI SDK through Flatkey — including Claude, Gemini, DeepSeek, and Qwen models.
</Tip>
