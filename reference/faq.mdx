...
<Accordion title="Which model names should I use?">
  Use the same canonical model IDs you would use with the original provider — for example `gpt-4o`, `claude-sonnet-4-5`, `gemini-2.5-flash`. The full list is in the [Model Directory](https://flatkey.ai/models).
</Accordion>
...
Committed-volume discounts, custom routing, invoicing, and procurement are covered on the [Enterprise](/reference/enterprise) page.
